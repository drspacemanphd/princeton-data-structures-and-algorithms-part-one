...
import com.markbrown.connectivity.assignments.impl.TwoDimensionalQuickFind;;

public class QuickFindPercolationApp extends AbstractPercolationApp<TwoDimensionalQuickFind> {

    public QuickFindPercolationApp(int dimension, int trials) {
    ...
    public void runSimulations() {
        ...
        for (int i = 0; i < this.trials; i++) {
            ...
            pValues.add((double) ((this.dimension * this.dimension) - this.closedSites.size())
    ...
    private void resetSimulation() {
        algorithm = new TwoDimensionalQuickFind(dimension);
